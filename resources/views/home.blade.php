...
<html class="no-js" lang="">
    <head>
	    ...
	    <meta name="author" content="Itcahi Solutions">
	...
	<script src="js/respond.min.js"></script> <![endif]--> 		
		...
		<link href="{{ asset('/sima-assets/css/normalize.css') }}" rel="stylesheet">
		<link href="{{ asset('/sima-assets/css/main.css') }}" rel="stylesheet">
		<link href="{{ asset('/sima-assets/css/bootstrap.min.css') }}" rel="stylesheet">
		<link href="{{ asset('/sima-assets/css/font-awesome.min.css') }}" rel="stylesheet">
		<link href="{{ asset('/sima-assets/css/owl.carousel.css') }}" rel="stylesheet">
		<link href="{{ asset('/sima-assets/css/responsive.css') }}" rel="stylesheet">
		<link href="{{ asset('/sima-assets/css/style.css') }}" rel="stylesheet">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-12">
				<div class="rgt_hd">
					<a href="index.html"><img src="sima-assets/img/logo.png" alt=""/></a>
				</div>
			</div>			
				...
				<div class="rgt_hd">					
					<div class="main_menu">
						...
						<div id="navbar">
							...
							<ul>
								<li><a class="page-scroll" href="#abt_sec">Projects</a></li>
								<li><a class="page-scroll" href="#tm_sec">Executives</a></li>
								<li><a class="page-scroll" href="#tstm_sec">Gamnia Ports Authority</a></li>
								<li><a class="page-scroll" href="#lts_sec">History</a></li>
							...
							<li><a href="#">Services<i class="fa fa-angle-down"></i></a>
								<ul>
									<li><a class="page-scroll" href="blog.html">Staff Canteen</a></li>
									<li><a class="page-scroll" href="single.html">Loans</a></li>
									<li><a class="page-scroll" href="single.html">Food Store</a></li>
								</ul>
							</li> 
							...
							<li><a href="#">Projects<i class="fa fa-angle-down"></i></a>								
								<ul>
									...
									<li><a class="page-scroll" href="#skill_sec">All Projects</a></li>
									<li><a class="page-scroll" href="#pr_sec">Sponsor A Project</a></li>
								</ul>
							</li>
							<li>
							...
							@else
								<li><a class="page-scroll" href="{{ url(config('laraadmin.adminRoute'))}}">{{ Auth::user()->name }}</a></li>
							@endif
							</ul>
						</div>		
						</nav>			
			...
			<div class="col-lg-2 col-md-2 col-sm-12">
				<div class="rgt_hd">
					<a href="index.html"><img src="sima-assets/img/gpa_logo.jpg" alt=""/></a>
				</div>
			</div>
		</div>	
	</div>	
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="copy_right">
					<li>&copy;GPA {{date("Y")}}</li>
					<li>developed by Itachi</li>
				</ul>					
			</div>	
		</div>
	</div>
...
<script src="{{ asset('/sima-assets/js/vendor/jquery-1.11.3.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/isotope.pkgd.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/jquery-ui.js') }}"></script>
<script src="{{ asset('/sima-assets/js/appear.js') }}"></script>
<script src="{{ asset('/sima-assets/js/jquery.counterup.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/waypoints.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/showHide.js') }}"></script>
<script src="{{ asset('/sima-assets/js/jquery.nicescroll.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/jquery.easing.min.js') }}"></script>
<script src="{{ asset('/sima-assets/js/scrolling-nav.js') }}"></script>
<script src="{{ asset('/sima-assets/js/plugins.js') }}"></script>
		...
		<script>
			function initialize() {
			  var mapOptions = {
				zoom: 14,
				scrollwheel: false,
				center: new google.maps.LatLng(13.444936, -16.573472)
			  };
			  ...
			  var marker = new google.maps.Marker({
				...
				icon: 'sima-assets/img/map-marker.png',
				map: map
			  });
			}
			google.maps.event.addDomListener(window, 'load', initialize);
		</script>
<script src="{{ asset('/sima-assets/js/main.js') }}"></script>
