	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $article->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Articles", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/articles/'.$article->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Articles", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.articles.destroy', $article->id], 'method' => 'delete', 'style'=>'display:inline']) }}
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'body')
						@la_display($module, 'article_type')
